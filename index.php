...
<html>
  ...
  <?php include "includes/header.php" ?>
    ...
    <section class="site-hero overlay" style="background-image: url(images/fotos-Sal/sm.jpg)" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center" data-aos="fade-up">
            <span class="custom-caption text-uppercase text-white d-block  mb-3">Bem Vindo ao 5 <span class="fa fa-star text-primary"></span>   Hotel</span>
              ...
              <div class="row">
                <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
                  ...
                  <div class="field-icon-wrap">
                    ...
                    <input type="date" name="checkin" class="form-control" placeholder="DD/MM/YYYY">
                  </div>
                </div>
                <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
                  <label for="checkout_date" class="font-weight-bold text-black"> Data saida</label>
                  <div class="field-icon-wrap">
                    <div class="icon"><span class="icon-calendar"></span></div>
                    <input type="date" name="checkout" class="form-control" placeholder="DD/MM/YYYY">
                  </div>
                </div>
